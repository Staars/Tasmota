...
#define COLOR_BG_PR         (IS_LIGHT ? lv_color_hex(0xeeeeee) : lv_color_hex(0x000000)) //(0x494f57))
...
static void basic_init(void)
{
    ...
    lv_style_set_radius(&styles->bg, LV_STATE_DEFAULT, LV_DPX(1)); //LV_DPX(8)
    ...
    lv_style_set_radius(&styles->btn, LV_STATE_DEFAULT, LV_DPX(1));
    ...
    lv_style_set_pad_left(&styles->btn, LV_STATE_DEFAULT, LV_DPX(10));
    lv_style_set_pad_right(&styles->btn, LV_STATE_DEFAULT, LV_DPX(10));
    ...
    lv_style_int_t pad_small_value = lv_disp_get_size_category(NULL) <= LV_DISP_MEDIUM_LIMIT ? LV_DPX(2) : LV_DPX(4);
